 ...
 */
package uk.tomr.integration.ocp;
...
@MessageDriven(name = "RemoteQueueMDB", activationConfig = {
    ...
    @ActivationConfigProperty(propertyName = "destination", propertyValue = "${remote.in.queue.short}"),
...
public class RemoteQueueMDB implements MessageListener {
    ...
    @Resource(name = "${remote.out.queue.long}")
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            try {
                ...
                LOG.errorf(jmsException, "MDB[%d ] Caught JMSExeption while cleaning up JMS resources.", mdbID);
